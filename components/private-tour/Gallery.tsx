    ...
    <section className="py-16 md:py-20 bg-[#101010]">
      <div className="max-w-7xl mx-auto px-4 md:px-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-[24px] w-full">
          {/* Column 1: Video */}
          <div className="relative w-full aspect-square sm:aspect-[2/3] md:aspect-[2/4] rounded-[24px] overflow-hidden bg-black">
            <video
              ref={videoRef}
          ...
          {/* Column 2: Fireworks */}
          <div className="w-full aspect-square sm:aspect-[2/3] md:aspect-[2/4] rounded-[24px] overflow-hidden">
          ...
          <div className="w-full aspect-[2/3] md:aspect-auto h-full grid grid-rows-2 gap-[24px] rounded-[24px] overflow-hidden">
            <div className="w-full h-full rounded-[24px] overflow-hidden">
              <img src={images[1].src} alt={images[1].alt} className="w-full h-full object-cover rounded-[24px]" />
            </div>
            <div className="w-full h-full rounded-[24px] overflow-hidden">
              <img src={images[2].src} alt={images[2].alt} className="w-full h-full object-cover rounded-[24px]" />
            </div>
          </div>
          {/* Column 4: Carnival ride with overlay button */}
          <div className="relative w-full aspect-square sm:aspect-[2/3] md:aspect-[2/4] rounded-[24px] overflow-hidden">
