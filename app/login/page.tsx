...
export default function LoginPage() {
  ...
  return (
    <>
      {/* Mobile Hero Section */}
      <div className="lg:hidden relative w-full h-48 bg-cover bg-center" style={{ backgroundImage: "url('https://images.pexels.com/photos/1591447/pexels-photo-1591447.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&fit=crop')" }}>
        ...
        <div className="hidden lg:flex xl:w-1/2 flex-col justify-end items-center p-4 h-[992px] bg-transparent rounded-[24px]">
          ...
          <div className="flex-1 w-full rounded-[24px] overflow-hidden mb-4">
            <div
              ...
              style={{
                backgroundImage: "url('https://images.pexels.com/photos/1591447/pexels-photo-1591447.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop')"
              }}
            />
          </div>
          ...
          <div className="w-full h-48 relative rounded-[16px] overflow-hidden">
            <div
              className="w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('https://images.pexels.com/photos/1591056/pexels-photo-1591056.jpeg?auto=compress&cs=tinysrgb&w=800&h=300&fit=crop')"
              }}
            >
              {/* Glassmorphic Text Overlay */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="rounded-[12px] w-[95%] mx-auto p-6">
                  <h3 className="text-white text-xl md:text-2xl uppercase tracking-wide text-center">
        ...
        <div className="w-full xl:w-[696px] my-4 flex flex-col justify-center items-start px-4 sm:px-8 lg:px-[80px] py-8 lg:py-0 gap-10 bg-white rounded-none lg:rounded-[24px] mx-0">
          <div className="w-full max-w-[536px] flex flex-col gap-10 mx-auto">
            ...
            <div className="flex flex-col items-start gap-4 w-full">
              <h1 className="mt-4 text-[2rem] sm:text-[2.5rem] lg:text-[48px] font-normal leading-tight tracking-normal text-[#101010] uppercase mb-0 w-full">
                YOUR GATEWAY TO UNFORGETTABLE JOURNEYS
              </h1>
              <p className="text-base sm:text-[16px] font-medium leading-[150%] text-[#878787] w-full">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 w-full">
                <div className="flex flex-row items-center gap-3">
                  ...
                  />
                  <label htmlFor="remember-me" className="text-[16px] font-medium text-[#101010]">Remember me</label>
                </div>
              ...
              <div className="flex flex-row items-center gap-6 w-full">
                ...
                <span className="text-[16px] font-medium text-[#101010]">Or</span>
                <div className="flex-1 border-t border-[#D6D6D6]"></div>
              </div>
              {/* Social Buttons */}
              <div className="flex flex-col gap-4 w-full">
                <button type="button" className="flex flex-row justify-center items-center gap-3 w-full h-14 px-5 bg-white border border-[#EDEDED] rounded-[6px] shadow-sm font-semibold text-[16px] text-[#383838]">
                  {/* Google Icon */}
                  <span className="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-white text-xs">G</span>
                  Sign in with Google
                </button>
                <button type="button" className="flex flex-row justify-center items-center gap-3 w-full h-14 px-5 bg-[#101010] rounded-[6px] shadow-sm font-semibold text-[16px] text-white">
                  {/* Apple Icon */}
                  <span className="w-6 h-6 bg-white rounded-full flex items-center justify-center text-black text-xs">A</span>
                  Sign in with Apple
                </button>
                <button type="button" className="flex flex-row justify-center items-center gap-3 w-full h-14 px-5 bg-[#1877F2] rounded-[6px] shadow-sm font-semibold text-[16px] text-white">
                  {/* Facebook Icon */}
                  <span className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs">f</span>
