...
const Register = () => {
  ...
  return (
    <>
      {/* Mobile Hero Section */}
      <div className="lg:hidden relative w-full h-48 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/Register-img.jpg')" }}>
      ...
      <div className="flex flex-col xl:flex-row lg:min-h-screen h-auto bg-[#101010] overflow-hidden">
        ...
        <div className="hidden lg:flex flex-col justify-end items-center p-[40px] m-4 xl:w-[696px] h-[992px] bg-[linear-gradient(180deg,rgba(0,0,0,0.048)_44.05%,rgba(0,0,0,0.2)_100%),url('/assets/images/Register-img.jpg')] bg-cover bg-center rounded-[24px] flex-none order-0 self-stretch flex-grow">
          ...
          <div className="flex flex-col items-start p-[24px] gap-[24px] xl:w-[616px] h-[372px] backdrop-blur-[9px] rounded-[12px] flex-none order-0 self-stretch flex-grow-0" style={{ background: "rgba(255,255,255,0.16)" }}>
            ...
            <div className="flex flex-col items-start p-0 gap-[4px] w-[568px] h-[57px] flex-none order-0 self-stretch flex-grow-0">
              <h3 className="font-anton text-2xl leading-[120%] uppercase text-white font-normal w-[568px] h-[29px]">EXCLUSIVE OFFERS:</h3>
              <p className="font-inter font-medium text-base leading-[150%] text-white w-[568px] h-[24px]">Be the first to know about our latest deals and promotions.</p>
            </div>
            {/* PERSONALIZED RECOMMENDATIONS */}
            <div className="flex flex-col items-start p-0 gap-[4px] w-[568px] h-[81px] flex-none order-1 self-stretch flex-grow-0">
              <h3 className="font-anton text-2xl leading-[120%] uppercase text-white font-normal w-[568px] h-[29px]">PERSONALIZED RECOMMENDATIONS:</h3>
              <p className="font-inter font-medium text-base leading-[150%] text-white w-[568px] h-[48px]">Be the first to know Get travel suggestions tailored to your preferences. About our latest deals and promotions.</p>
            </div>
            {/* SEAMLESS EXPERIENCE */}
            <div className="flex flex-col items-start p-0 gap-[4px] w-[568px] h-[57px] flex-none order-2 self-stretch flex-grow-0">
              <h3 className="font-anton text-2xl leading-[120%] uppercase text-white font-normal w-[568px] h-[29px]">SEAMLESS EXPERIENCE:</h3>
              <p className="font-inter font-medium text-base leading-[150%] text-white w-[568px] h-[24px]">Save your details for faster, more convenient bookings.</p>
            </div>
            {/* 24/7 CUSTOMER SUPPORT */}
            <div className="flex flex-col items-start p-0 gap-[4px] w-[568px] h-[57px] flex-none order-3 self-stretch flex-grow-0">
              <h3 className="font-anton text-2xl leading-[120%] uppercase text-white font-normal w-[568px] h-[29px]">24/7 CUSTOMER SUPPORT:</h3>
              <p className="font-inter font-medium text-base leading-[150%] text-white w-[568px] h-[24px]">Enjoy peace of mind with our dedicated support team.</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full xl:w-1/2 flex my-4 pb-4 md:pb-0 px-4 sm:px-8 lg:px-[80px] mr-4 lg:p-12 bg-white rounded-[24px]">
          <div className="w-full md:max-w-[536px] flex flex-col gap-12 mx-auto">
            <div className="max-w-[536px] mt-5">
              <h1 className="font-anton text-2xl md:text-5xl font-normal leading-tight tracking-normal text-[#101010] uppercase mb-4">
                JOIN TRAVELER AND YOUR ADVENTURE AWAITS
              </h1>
              <p className="font-inter text-base font-medium leading-normal tracking-normal text-[#878787]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full max-w-[536px] p-0">
              ...
              <div className="flex flex-col gap-3 w-full">
                <label className="block text-[16px] font-inter font-medium text-[#101010]">Username</label>
                <Input
                  name="firstName"
                  type="text"
              ...
              {/* Confirm Password */}
              <div className="flex flex-col gap-3 w-full">
                <label className="block text-[16px] font-inter font-medium text-[#101010]">Confirm Password</label>
                <div className="relative w-full">
                  <Input
              ...
              {/* Policy Text */}
              <div className="text-[16px] font-inter font-medium text-[#878787]">
