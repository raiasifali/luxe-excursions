...
export const staticExperiences: StaticExperienceItem[] = [
  {
    ...
    description:
      '4 Excursions. Private yacht charter (3h, 1-6 ppl) + Champagne, Drinks & Snacks, Whales & Dolphins, Paddle Boards. Plus 3 excursions of your choosing. Free luxury transfers incl. Airport/Port pickup & minibar. Filming included.',
  ...
  },
  {
    ...
    description:
      '4 Excursions. Private charter (3h, 1-6 ppl) + Champagne, Whales & Dolphins, Drinks & Snacks. Plus 3 excursions of your choosing. Free luxury transfers between every activity.',
  ...
  },
  {
    ...
    description:
      '3 Excursions of your choosing. Free luxury transfers between every excursion, event or activity.',
