...
const experiences = [
  ...
  {
    id: 2,
    image: "https://images.pexels.com/photos/1591056/pexels-photo-1591056.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop",
  ...
  {
    id: 3,
    image: "https://images.pexels.com/photos/1591373/pexels-photo-1591373.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop",
  ...
  {
    id: 4,
    image: "https://images.pexels.com/photos/1597447/pexels-photo-1597447.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop",
  ...
  {
    id: 5,
    image: "https://images.pexels.com/photos/1598073/pexels-photo-1598073.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop",
  ...
  {
    id: 6,
    image: "https://images.pexels.com/photos/1599447/pexels-photo-1599447.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop",
    ...
    <section className="w-full bg-white flex flex-col items-center pt-8 sm:pt-10 md:pt-16 lg:pt-20">
      <div className="w-full max-w-full px-2 sm:px-4 xl:px-20 lg:px-10 md:px-5">
        <div className="flex items-center justify-between mb-6 sm:mb-8 md:mb-12">
          <h2 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#232323] uppercase">SIMILAR EXPERIENCES</h2>
