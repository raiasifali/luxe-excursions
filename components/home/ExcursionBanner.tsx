...
const ExcursionBanner = () => (
  <section className="py-20 text-white relative bg-cover bg-center mx-5 lg:mx-[60px] mt-24 rounded-[20px]" style={{
    ...
    <div className="relative z-10 xl:max-w-7xl max-w-auto mx-auto text-center lg:px-[60px] px-10">
      <h2 className="text-4xl md:text-5xl font-normal mb-8">Our Excursions</h2>
      <p className="text-lg mb-8 text-[#D9D9D9] mx-auto leading-tight text-center">
      ...
      <Button className="bg-[#E0C469] text-[#252525] hover:bg-gray-100 px-10 py-5 text-lg">
