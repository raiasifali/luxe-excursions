  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen bg-cover bg-center" style={{
        backgroundImage: "url('https://images.pexels.com/photos/1591447/pexels-photo-1591447.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&fit=crop')"
      }}>
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center mx-auto px-4 md:px-20">
            <h1 className="text-4xl md:text-6xl lg:text-[64px] font-normal mb-6 text-white !leading-[120%] animate-fade-in">
      ...
      <section className="py-20" style={{
        ...
        <div className="mx-auto xl:px-20 px-5 text-center">
          <h2 className="text-5xl md:text-6xl lg:text-[64px] font-normal text-white mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group relative lg:h-[587px] md:h-auto rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105">
              ...
              <div className="absolute inset-0">
                <div className="absolute w-[93%] left-1/2 -translate-x-1/2 bottom-6 bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-6 py-4 flex flex-col items-center transition-all duration-300">
                  <h3 className="font-normal uppercase text-white text-3xl md:text-3xl mb-2 text-center">
                    Private Tours
                  </h3>
                  <p className="w-[246px] h-12 font-medium text-base leading-[150%] text-center text-white">
            ...
            <div className="group relative lg:h-[587px] md:h-auto rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105">
              <img 
                src="https://images.pexels.com/photos/1591056/pexels-photo-1591056.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop" 
                alt="Premium Rentals" 
                className="w-full h-full object-cover" 
              />
              <div className="absolute inset-0">
                <div className="absolute w-[92%] left-1/2 -translate-x-1/2 bottom-6 bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-6 py-4 flex flex-col items-center transition-all duration-300">
                  <h3 className="font-bold uppercase text-white text-2xl md:text-3xl mb-2 text-center">
                    Premium Rentals
                  </h3>
                  <p className="w-[246px] h-12 font-medium text-base leading-[150%] text-center text-white">
            ...
            <div className="flex flex-col gap-4 lg:h-[587px] md:h-auto">
              <div className="group relative flex-1 rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center lg:items-end lg:justify-end">
                  <div className="bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-4 py-6 flex flex-col transition-all duration-300 max-w-[90%] mx-auto mb-0 lg:mb-8">
                    <h3 className="text-xl text-white font-normal mb-1 text-center">
                      Adventure Activities
                    </h3>
                    <p className="text-white/90 text-sm font-normal text-center">
              ...
              <div className="group relative flex-1 rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105">
                <img 
                  src="https://images.pexels.com/photos/1597447/pexels-photo-1597447.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop" 
                  alt="Water Sports" 
                  className="w-full h-full object-cover" 
                />
              </div>
            ...
            <div className="group relative lg:h-[587px] md:h-auto rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105">
              <img 
                src="https://images.pexels.com/photos/1598073/pexels-photo-1598073.jpeg?auto=compress&cs=tinysrgb&w=400&h=600&fit=crop" 
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto px-4 md:px-20 text-center">
          <blockquote className="xl:w-[1280px] w-auto h-auto font-normal xl:text-6xl xl:leading-none lg:text-3xl md:text-2xl text-xl leading-[120%] uppercase">
            <span style={{
              color: '#101010'
            }}>
      ...
      <section className="pb-6">
        <div className="mx-auto xl:px-20 lg:px-10 px-5">
          <div className="relative bg-cover bg-center rounded-2xl overflow-hidden" style={{
            backgroundImage: "url('https://images.pexels.com/photos/1599447/pexels-photo-1599447.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop')"
          }}>
            <div className="absolute inset-0 bg-black/40"></div>
            <div className="relative z-10 px-8 py-20 text-center">
              <h2 className="font-normal text-2xl md:text-3xl lg:text-[32px] uppercase text-white text-center max-w-full mx-auto">
                DIAMOND EXPERIENCE
              </h2>
              <h3 className="font-normal text-base md:text-lg lg:text-[18px] uppercase text-white text-center w-[822px] h-[58px] max-w-full mx-auto">
                PRIVATE YACHT CHARTER (3 HOURS)
              </h3>
              <p className="text-sm leading-relaxed font-normal max-w-[822px] mx-auto text-white/90">
        ...
        <div className="mx-auto xl:px-20 lg:px-10 px-5">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div className="group relative overflow-hidden rounded-3xl shadow-lg w-full max-w-[400px] mx-auto lg:max-w-none min-h-[340px] lg:h-[587px]">
              <img 
                src="https://images.pexels.com/photos/1600709/pexels-photo-1600709.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&fit=crop" 
                alt="Stunning Experience" 
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" 
              />
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center lg:items-end lg:justify-end">
                <div className="bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-4 py-6 flex flex-col transition-all duration-300 max-w-[90%] mx-auto mb-0 lg:mb-8">
                  <h3 className="text-[32px] text-white font-normal mb-2 uppercase w-auto max-w-full break-words text-center lg:text-left">
                    Gold Experience
                    <span className="text-base ml-4">(PRIVATE YACHT CHARTER (3 HOURS) )</span>
                  </h3>
                  <p className="text-white/90 text-sm font-normal w-auto max-w-full break-words text-center lg:text-left">
            ...
            <div className="flex flex-col gap-4 lg:gap-6 w-full max-w-[400px] mx-auto lg:max-w-none">
              <div className="group relative overflow-hidden rounded-3xl shadow-lg flex-1 w-full min-h-[220px] lg:min-h-0">
                <img 
                  src="https://images.pexels.com/photos/1601774/pexels-photo-1601774.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop" 
                  alt="Adventure Awaits" 
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" 
                />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center lg:items-end lg:justify-end">
                  <div className="bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-4 py-6 flex flex-col transition-all duration-300 max-w-[90%] mx-auto mb-0 lg:mb-8">
                    <h3 className="text-xl text-white font-normal mb-1 w-auto max-w-full break-words text-center lg:text-left">Custom Experience</h3>
                    <p className="text-white/90 text-sm w-auto max-w-full break-words text-center lg:text-left">Our Custom Experience Package is designed to create unforgettable memories for travelers seeking flexibility. Enjoy a mix of relaxation and adventure with luxury transfers, professional filming options, and three excursions, events, or activities of your choice.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-3xl shadow-lg flex-1 w-full min-h-[220px] lg:min-h-0">
                <img 
                  src="https://images.pexels.com/photos/1602726/pexels-photo-1602726.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop" 
                  alt="Custom Experience" 
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" 
                />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center lg:items-end lg:justify-end">
                  <div className="bg-[#FCFCFC03] group-hover:bg-black/80 backdrop-blur-sm rounded-xl px-4 py-6 flex flex-col transition-all duration-300 max-w-[90%] mx-auto mb-0 lg:mb-8">
                    <h3 className="text-xl text-white font-normal mb-1 uppercase w-auto max-w-full break-words text-center lg:text-left">Party Experience</h3>
                    <p className="text-white/90 text-sm w-auto max-w-full break-words text-center lg:text-left">Our Party Experience Package is designed to create unforgettable memories for travelers who love to celebrate. Enjoy a mix of relaxation and excitement with one excursion or event of your choice, including a boat party, pool party, and luxury transfers.</p>
                  </div>
                </div>
              </div>
            </div>
